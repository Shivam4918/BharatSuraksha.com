 ...
 <div class="container-fluid">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <div class="head">
                    <h1 style="font-family: 'Slackside One', cursive;">Slider</h1>
                    <button id="add-media" style="font-family: 'Slackside One', cursive;" class="btn-add">ADD Slider</button>
                </div>
                    ...
                    <?php
                        ...
                        ?>
                            <tr>
                                ...
                                <td><i class="far fa-times-circle text-danger ml-2 fa-lg" onclick="deleteMedia(<?php echo $row['id'] ?>)"></i></td>
                            </tr>
                        <?php
                            }
                        ?>
            ...
            <div class="col-lg-6 upalod-box" id="show-media" style="display:none;">
                <div class="upload-box-head">
                    <span style="font-family: Leckerli One, cursive;font-size:25px;">add Slider</span>
                    ...
                    <form id="mediaForm" class="media_form" method="POST" enctype="multipart/form-data">
                        <label class="mt-10 mb-10 w3-lobster" style="margin:15px;" ><b style="font-family: 'Lugrasimo', cursive;font-size:18px;">Upload Slider Image:</b></label>
