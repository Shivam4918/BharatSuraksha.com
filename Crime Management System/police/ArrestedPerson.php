...
<body onload="startSpinner()">
    ...
    <div id="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="container">
                <button id="addArrestedBtn" class="btn btn-success"> <i class="fa fa-plus-circle"></i> Add Person</button>
            </div>
                <div class="container criminal_box" id="criminal_box" style="display:none">
                    <form id="ArrestedForm" method="POST" enctype="multipart/form-data" autocomplete="off">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input  id="dob" class="dob" onkeydown="return false" type="date" name="dob">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                    ...
                                    <input  id="arrest_date" class="arrest_date" onkeydown="return false" type="date" name="arrest_date">
                            ...
                            <div class="col-md-4">
                                    ...
                                    <small><span class="Error arreste_time_err"></span></small>
                            </div>
                            <div class="col-md-4">
...
<div id="modal">
    <div id="modal-form">
        ...
        <form id="updateArrestedForm" method="POST" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                        ...
                        <input  id="update_dob" onkeydown="return false" class="update_dob" type="date" name="update_dob">
            ...
            <div class="row">
                <div class="col-md-4">
                        ...
                        <input  id="update_arrest_date" onkeydown="return false" class="update_arrest_date" type="date" name="update_arrest_date">
...
<!-- <script src="https://cdn.jsdelivr.net/npm/sweetalert2@9"></script> -->
    ...
    <script>
        ...
        // feature date and time disable 
            ...
            document.getElementById("arrest_date").setAttribute("max", day);
            document.getElementById("update_arrest_date").setAttribute("max", day);
        ...
        function addArrestedPerson(e){
            ...
            function check_name(){
                if(!arrested_name.match(string_pattern)){
                    ...
                    $(".Arrested_Name_err").html("* Invalid Name");
                    return false;
                }else{
            ...
            function arreste_check_time(){
                const day = new Date().toISOString().split('T')[0];
                const Time = new Date();
                const toTime = Time.getHours()+":"+Time.getMinutes();
                
                if((day==arrested_date) && (arrested_time>=toTime)){
                    $(".arreste_time_err").show();
                    $(".arreste_time_err").html("*Please Enter Proper Time");
                    return false;
                }else{
                    $(".arreste_time_err").hide();
                    $(".arreste_time_err").html("");
                    return true;
                }
            }
            ...
            if(arrested_name!="" && gender!=-1 && dob!="" && arrested_date!="" && arrested_time!="" && crime_id!=-1 && location!="" && bail_amount!=""){
                ...
                if(check_name() && check_gender() && check_Bail_Amount() && arreste_check_time()){
                    if(img != null){
        ...
        function updateArrestedPerson(e){
            ...
            function check_name(){
                if(!arrested_name.match(string_pattern)){
                    ...
                    $(".update_Arrested_Name_err").html("* Invalid Name");
                    return false;
                }else{
            ...
            function arreste_check_time(){
                ...
                if((day==arrested_date) && (arrested_time>=toTime)){
                    $(".update_aarrest_time_err").show();
                    $(".update_aarrest_time_err").html("*Please Enter Proper Time");
                    return false;
                }else{
                    $(".update_aarrest_time_err").hide();
                    $(".update_aarrest_time_err").html("");
                    return true;
                }
            }
        ...
        function deletePerson(id){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $(".loader").show();
                    $.ajax({
                        url: "./php/crud.php?deleteArrested="+id,
                        type: "GET",
                        success: function(response) {
                            $(".loader").hide();
                            if(response == 1){
