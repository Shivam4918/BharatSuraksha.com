...
if(!isset($_SESSION['pid'])){
  header('Location:index.php');
    ...
    $fid = $_GET['id'];
    $vehical_sql = "SELECT * FROM vehical_fir WHERE fir_id= $fid";
    $vehical_result =$conn->query($vehical_sql);
    $vehical_row = $vehical_result->fetch_assoc();
    $vehical_station_id = $vehical_row['station_id'];
    ...
    if($vehical_station_id!=$police_station_id){
        ...
        <div class="container detail_page">
            <form action="#" method="post">
                <table class="table table-striped table-responsive">
                    <?php
                        $fid = $_GET['id'];
                        $sql = "SELECT * FROM vehical_fir WHERE fir_id= $fid";
                        ...
                        while($row = $result->fetch_assoc()){
                            ?>
                                ...
                                <tr>
                                    <th>MOBILE BILL</th>
                                    <td><a href="#popup1" class="text-dark fw-bold" style="cursor:pointer;" onclick="getimage('<?php echo $row['vehical_rc']; ?>');">View Image</a></td>
                                </tr>
                            <?php
                        }
                    ?>
